<template>
    div
    <div class="flex items-center space-x-2 border border-gray-300 rounded-lg px-3.5 py-2.5">
        <input
            class="flex-1 border-none outline-none ring-0 focus:outline-0 focus:ring-0 focus:border-none"
            :value="modelValue"
            @input="onInput"
            :type="field?.type"
