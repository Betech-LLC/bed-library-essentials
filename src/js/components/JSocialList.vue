<template>
    <div class="share-list">
        ...
        <a v-if="checkShow('messenger')" :href="messageUrl" target="_blank" class="share-item">
            <slot name="messenger">
        ...
        <a v-if="checkShow('linkedin')" :href="linkedinUrl" target="_blank" class="share-item">
            <svg
                class="w-[30px] h-[30px]"
                width="24"
                height="24"
        ...
        <a v-if="checkShow('facebook')" :href="facebookUrl" target="_blank" class="share-item">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="12" r="10.5" fill="url(#paint0_linear_8740_155862)" />
                <path
        ...
        <div class="share-item" v-if="checkShow('zalo')">
            <client-only>
                <div
        ...
        <a v-if="checkShow('pinterest')" :href="pinterestUrl" target="_blank" class="share-item">
            <svg
                class="w-[30px] h-[30px]"
                xmlns="http://www.w3.org/2000/svg"
                width="30"
        ...
        <div v-if="checkShow('copy-link')" class="relative inline-block cursor-pointer">
            ...
            <div
                class="absolute top-1/2 -translate-y-1/2 bg-gray-400 text-white duration-300 pt-[4px] pb-[6px] px-[12px] w-max left-[150%] rounded cursor-default lg:text-[0.875rem] text-[0.75rem] font-sans leading-[100%] hidden md:block"
                :class="copySuccess ? 'opacity-100 visible' : 'opacity-0 invisible'"
            >
                Link copied!
            </div>
        </div>
        <a v-if="checkShow('twitter')" :href="twitterUrl" target="_blank" class="share-item">
            <svg
                class="w-[30px] h-[30px]"
                width="24"
                height="24"
