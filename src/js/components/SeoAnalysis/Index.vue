  ...
  <div class="seo-analysis">
      ...
      <div class="preview-content" :class="currentDevice">
        <div class="preview">
          ...
          <a
            ...
            @click="scrollToSection('#seo-description')"
    ...
    <div class="content-wrapper">
      <div class="field-group" id="seo-title">
        <label class="flex items-center">
          ...
          <div class="status-bar">
            ...
            <div class="bar">
              ...
              <div
                class="progress"
                :style="{ width: 100 - seoAnalysis.keywordScore?.score + '%' }"
              ></div>
              <div class="divide">
                <div></div>
                <div></div>
        ...
        <small>Từ khóa dùng để đo đếm mức độ liên quan của Tiêu đề, Mô tả và Nội dung bài viết. Hãy chọn từ khóa súc tích</small>
      </div>
      <div class="field-group" id="seo-title">
        <label class="flex items-center">
          ...
          <div class="status-bar">
            ...
            <div class="bar">
              ...
              <div
                class="progress"
                :style="{ width: 100 - seoAnalysis.titleScore?.score + '%' }"
              ></div>
              <div class="divide">
                <div></div>
                <div></div>
        ...
        <small>
          Đoạn tiêu đề này sẽ được hiển thị đầu tiên khi trên các bộ máy tìm
          kiếm
        </small>
      ...
      <div class="field-group" id="seo-description">
        ...
        <small>
          Đoạn văn bản này sẽ được hiển thị bên dưới tiêu đề lớn khi trên các bộ
          máy tìm kiếm
        </small>
...
export default {
  ...
  methods: {
    calculateTitleWidth() {
      this.titleWidth =
        document.querySelector(".title-hidden")?.scrollWidth ?? 0;
    },
    calculateDescriptionWidth() {
      this.descriptionWidth =
        document.querySelector(".description-hidden")?.scrollWidth ?? 0;
    },
