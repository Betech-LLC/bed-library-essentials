<template>
  <section class="error">
    ...
    <img
      src="../../images/error/image-page.webp"
      class="error-image"
      alt="Error"
    />
  </section>
...
export default {
  props: {
    ...
    description: {
      type: String,
      default:
        "Địa chỉ truy cập không tồn tại hoặc đã bị xóa. Trong trường hợp khẩn cấp, Quý khách vui lòng liên hệ hotline",
    },
    phone: {
      type: String,
      default: "+1800 9090 9090",
    },
    button: {
      type: String,
